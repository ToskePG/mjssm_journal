...
Monten. J. Sports Sci. Med. <?php echo $b_result["godina"]; ?>, <?php echo $b_result["vol"]; ?>(<?php

if($a_result["str"]=="5-37" || ($a_result["str"]=="5-19" && $a_result["broj"] == 20))
{
	echo "S1";
}
else{
